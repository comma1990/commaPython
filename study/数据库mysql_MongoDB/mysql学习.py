...
def update():
    connector=mysql.connector.connect(host='localhost',user='root',passwd='root',database='comma',auth_plugin='mysql_native_password')
    mycursor=connector.cursor()
    sql='update student set name="黄月英" where name="渣渣"'
