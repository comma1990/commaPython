...
class LianJiaSpider():
    ...
    def parse_html(self,resp):  # 解析html数据
        ...
        for item in li_list:
            ...
            totalPrice=item.find('div',class_='totalPrice').text+'万'
            unitPrice=item.find('div',class_='unitPrice').text+'元/平'
            ...
            lst.append((title,houseInfo,positionInfo,dealDate,totalPrice,unitPrice,dealHouseTxt,span_list[0].text,span_list[1].text,agent_name))
            print(lst)
